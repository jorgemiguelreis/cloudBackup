...
public class FragmentLayout extends Activity {
	...
	static XMLFilesData xmlFilesData = new XMLFilesData();
	@Override
...
/*
			//TODO get files list from cloud
			String[] fnames = null;
			try {
				Entry dirent = MainActivity.mDBApi.metadata(Utils.CloudSMSFolder, 1000, null, true, null);
...
*/
	...
	public static class DetailsFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			//******     CHANGE SMS_DIALOGUE to CallLog_DIALOGUE for Call Log Data        *******//
			text.setText(xmlFilesData.SMS_DIALOGUE[getShownIndex()]);
			return scroller;
		}
	}
